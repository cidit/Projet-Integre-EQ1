            ...
            return (
                <div>
                    <button className="btn btn-primary"
                            onClick={(event) => this.handleSubmit(event, true, etudiant.cv.id)}>Approuver
                    </button>
                    <button className="btn btn-primary"
                            onClick={(event) => this.handleSubmit(event, false, etudiant.cv.id)}>Refuser
                    </button>
                </div>
            )
        }
                                ...
                                .map(
                                    etudiant =>
                                        <tr key={etudiant.id}>
                                            ...
                                            <td>
                                                {etudiant.cv != null ? <button onClick={() => this.downloadCV(etudiant)}
                                                                               className="btn btn-primary">Télécharger</button>
                                                    : <p>Pas de CV</p>}<br/>
                                            </td>
                                            <td>
