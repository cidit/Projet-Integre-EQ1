    ...
    render() {
        return(
            <div className="container">
                ...
                {this.state.displayInvalidFileMessage ? <label style={{color: "red"}}>Ce format de fichier n'est pas autorise. Seuls les fichiers au format PDF sont autorises</label> : null}
